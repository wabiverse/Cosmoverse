...
class SwiftIgnoredPropertiesObject: Object
{
  ...
  override class func ignoredProperties() -> [String]
  {
    ["runtimeProperty", "runtimeDefaultProperty"]
  }
}
...
class SwiftIndexedPropertiesObject: Object
{
  ...
  {
    ["stringCol", "intCol", "int8Col", "int16Col",
...
class SwiftIndexedOptionalPropertiesObject: Object
{
  ...
  override class func indexedProperties() -> [String]
  {
    ["optionalStringCol", "optionalIntCol", "optionalInt8Col", "optionalInt16Col",
...
{
  var implicitlyIgnoredComputedProperty: Int { 0 }
  ...
  func parentFunction() -> Int { parentFirstNumber + 1 }
  @objc dynamic var parentSecondNumber = 1
  var parentComputedProp: String { "hello world" }
}
...
{
  func myFunction() -> Int { firstNumber + secondNumber + thirdNumber }
  @objc dynamic var dynamicComputed: Int { 999 }
  var firstIgnored = 999
  @objc dynamic var dynamicIgnored = 999
  @objc dynamic var firstNumber = 0 // Managed property
  class func myClassFunction(x: Int, y: Int) -> Int { x + y }
  ...
  var computedProp: String { "\(firstNumber), \(secondNumber), and \(thirdNumber)" }
  let secondArray = List<SwiftStringObject>() // Managed property
  let secondSet = MutableSet<SwiftStringObject>() // Managed property
  override class func ignoredProperties() -> [String]
  {
    ["firstIgnored", "dynamicIgnored", "secondIgnored", "thirdIgnored", "lazyIgnored", "dynamicLazyIgnored"]
  }
...
class SwiftRenamedProperties1: Object
{
  ...
  override class func _realmObjectName() -> String { "Swift Renamed Properties" }
  override class func propertiesMapping() -> [String: String]
  {
    ["propA": "prop 1", "propB": "prop 2"]
  }
}
...
class LinkToSwiftRenamedProperties1: Object
{
  ...
  override class func _realmObjectName() -> String { "Link To Swift Renamed Properties" }
  override class func propertiesMapping() -> [String: String]
  {
    ["linkA": "link 1", "linkB": "link 2", "array1": "array", "set1": "set"]
  }
}
...
class LinkToSwiftRenamedProperties2: Object
{
  ...
  override class func propertiesMapping() -> [String: String]
  {
    ["linkC": "link 1", "linkD": "link 2", "array2": "array", "set2": "set"]
  }
}
