...
{
  var collection: RLMSectionedResults<RLMValue, RLMValue>
  init(rlmSectionedResult: RLMSectionedResults<RLMValue, RLMValue>)
  {
  ...
  {
    Element(rlmSectionedResult: collection[UInt(index)])
  }
  ...
  {
    SectionedResultsIterator(collection: collection)
  }
...
public struct ResultsSection<Key: _Persistable & Hashable, T: RealmCollectionValue>: SectionedResultImpl
{
  ...
  var collection: RLMSection<RLMValue, RLMValue>
  init(rlmSectionedResult: RLMSection<RLMValue, RLMValue>)
  {
    collection = rlmSectionedResult
  }
  ...
  public var key: Key
  {
    Key._rlmFromObjc(collection.key)!
  }
  ...
  {
    T._rlmFromObjc(collection[UInt(index)])!
  }

  /// :nodoc:
  public func makeIterator() -> SectionIterator<Element>
  {
    SectionIterator(collection: collection)
  }
