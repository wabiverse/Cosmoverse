...
public extension FindOptions
{
  ...
  var projection: Document?
  {
    get
    {
      __projection.map(ObjectiveCSupport.convertBson)??.documentValue
    }
    set
    {
  ...
  var sort: Document?
  {
    get
    {
      __sort.map(ObjectiveCSupport.convertBson)??.documentValue
    }
    set
    {
  ...
  var sorting: [Document]
  {
    get
    {
      __sorting.map(ObjectiveCSupport.convertBson).map { $0!.documentValue! }
    }
    set
    {
...
public extension MongoCollection
{
  ...
  {
    __watch(with: ChangeEventDelegateProxy(delegate),
            delegateQueue: queue)
  }
...
public extension MongoCollection
{
            ...
            _ completion: @escaping MongoFindBlock)
  {
    ...
    __findWhere(bson, options: options)
    { documents, error in
  ...
  {
    let bson = ObjectiveCSupport.convert(filter)
    __findOneDocumentWhere(bson, options: options)
    { document, error in
      if let error
      {
  ...
  {
    let bson = ObjectiveCSupport.convert(filter)
    __countWhere(bson, limit: limit ?? 0)
    { count, error in
      if let error
      {
        completion(.failure(error))
  ...
  {
    let bson = ObjectiveCSupport.convert(filter)
    __deleteManyDocumentsWhere(bson)
    { count, error in
      if let error
      {
        completion(.failure(error))
  ...
  {
    let filterBSON = ObjectiveCSupport.convert(filter)
    __findOneAndDeleteWhere(filterBSON, options: options)
    { document, error in
      if let error
      {
        completion(.failure(error))
...
extension Publishers
{
  ...
  public struct WatchPublisher: Publisher
  {
    ...
    public func subscribe(on scheduler: some Scheduler) -> WatchPublisher
    {
      Self(collection: collection,
...
@usableFromInline
func future<T>(_ fn: @escaping (@escaping @Sendable (Result<T, Error>) -> Void) -> Void) -> Future<T, Error>
{
  Future<T, Error>
  { promise in
...
public extension MongoCollection
{
  ...
  {
    future { self.insertOne(document, $0) }
  }
  ...
  {
    future { self.insertMany(documents, $0) }
  }
  ...
  {
    future { self.find(filter: filter, options: options, $0) }
  }
  ...
  {
    future { self.find(filter: filter, $0) }
  }
  ...
  {
    future { self.findOneDocument(filter: filter, $0) }
  }
  ...
  {
    future { self.aggregate(pipeline: pipeline, $0) }
  }
  ...
  {
    future { self.count(filter: filter, limit: limit, $0) }
  }
  ...
  {
    future { self.count(filter: filter, $0) }
  }
  ...
  {
    future { self.deleteOneDocument(filter: filter, $0) }
  }
  ...
  {
    future { self.deleteManyDocuments(filter: filter, $0) }
  }
  ...
  {
    future { self.updateOneDocument(filter: filter, update: update, upsert: upsert, $0) }
  }
  ...
  {
    future { self.updateOneDocument(filter: filter, update: update, $0) }
  }
  ...
  {
    future { self.updateManyDocuments(filter: filter, update: update, upsert: upsert, $0) }
  }
  ...
  {
    future { self.updateManyDocuments(filter: filter, update: update, $0) }
  }
  ...
  {
    future { self.findOneAndUpdate(filter: filter, update: update, options: options, $0) }
  }
  ...
  {
    future { self.findOneAndUpdate(filter: filter, update: update, $0) }
  }
  ...
  {
    future { self.findOneAndReplace(filter: filter, replacement: replacement, options: options, $0) }
  }
  ...
  {
    future { self.findOneAndReplace(filter: filter, replacement: replacement, $0) }
  }
  ...
  {
    future { self.findOneAndDelete(filter: filter, options: options, $0) }
  }
  ...
  {
    future { self.findOneAndDelete(filter: filter, $0) }
  }
}
