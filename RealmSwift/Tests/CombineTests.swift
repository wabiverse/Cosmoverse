...
class CombineObjectPublisherTests: CombinePublisherTestCase
{
  ...
  {
    let exp = XCTestExpectation()
    cancellable = valuePublisher(obj).assertNoFailure().sink
    { o in
  ...
  {
    let exp = XCTestExpectation()
    cancellable = changesetPublisher(obj).assertNoFailure().sink
    { change in
  ...
  func testFrozenChangeSetSubscribeOn()
  {
    ...
    cancellable = changesetPublisher(obj)
      ...
      { arr in
        ...
        for change in arr
        {
          guard case let .change(obj, properties) = change
          else
          {
            XCTFail("Expected .change but got \(change)")
            sema.signal()
...
class ResultsPublisherTests: TestCase
{
  override class var defaultTestSuite: XCTestSuite
  {
    CombineCollectionPublisherTests<Results<ModernAllTypesObject>>.testSuite("Results")
  }
}
...
extension List: CombineTestCollection where Element == ModernAllTypesObject
{
  ...
  {
    try! realm.write { realm.create(ModernAllTypesObject.self).arrayCol }
  }
...
class ManagedListPublisherTests: TestCase
{
  override class var defaultTestSuite: XCTestSuite
  {
    CombineCollectionPublisherTests<List<ModernAllTypesObject>>.testSuite("List")
  }
}
...
extension MutableSet: CombineTestCollection where Element == ModernAllTypesObject
{
  ...
  {
    try! realm.write { realm.create(ModernAllTypesObject.self).setCol }
  }
...
class ManagedMutableSetPublisherTests: TestCase
{
  override class var defaultTestSuite: XCTestSuite
  {
    CombineCollectionPublisherTests<MutableSet<ModernAllTypesObject>>.testSuite("MutableSet")
  }
}
...
extension LinkingObjects: CombineTestCollection where Element == ModernAllTypesObject
{
  ...
  {
    try! realm.write { realm.create(ModernAllTypesObject.self).linkingObjects }
  }
...
class LinkingObjectsPublisherTests: TestCase
{
  override class var defaultTestSuite: XCTestSuite
  {
    CombineCollectionPublisherTests<LinkingObjects<ModernAllTypesObject>>.testSuite("LinkingObjects")
  }
}
...
extension AnyRealmCollection: CombineTestCollection where Element == ModernAllTypesObject
{
  ...
  {
    AnyRealmCollection(realm.objects(Element.self))
  }
...
class AnyRealmCollectionPublisherTests: TestCase
{
  override class var defaultTestSuite: XCTestSuite
  {
    CombineCollectionPublisherTests<AnyRealmCollection<ModernAllTypesObject>>.testSuite("AnyRealmCollection")
  }
}
...
extension Map: CombineTestCollection where Key == String, Value == SwiftObject?
{
  ...
  {
    try! realm.write { realm.create(SwiftMapPropertyObject.self).swiftObjectMap }
  }
...
class ManagedMapPublisherTests: TestCase
{
  override class var defaultTestSuite: XCTestSuite
  {
    CombineMapPublisherTests<Map<String, SwiftObject?>>.testSuite("Map")
  }
}
  ...
  where Collection: CombineTestCollection, Collection: RealmSubscribable, Collection.Element: RealmSectionedObject
{
  ...
  func checkChangeset(
    _ change: SectionedResultsChange<some RealmSectionedResult>,
...
class ResultsWithSectionedResultsPublisherTests: TestCase
{
  override class var defaultTestSuite: XCTestSuite
  {
    CombineSectionedResultsPublisherTests<Results<ModernAllTypesObject>>.testSuite("Results")
  }
}
...
class ManagedListSectionedResultsPublisherTests: TestCase
{
  override class var defaultTestSuite: XCTestSuite
  {
    CombineSectionedResultsPublisherTests<List<ModernAllTypesObject>>.testSuite("List")
  }
}
...
class ManagedMutableSetSectionedResultsPublisherTests: TestCase
{
  override class var defaultTestSuite: XCTestSuite
  {
    CombineSectionedResultsPublisherTests<MutableSet<ModernAllTypesObject>>.testSuite("MutableSet")
  }
}
...
class LinkingObjectsSectionedResultsPublisherTests: TestCase
{
  override class var defaultTestSuite: XCTestSuite
  {
    CombineSectionedResultsPublisherTests<LinkingObjects<ModernAllTypesObject>>.testSuite("LinkingObjects")
  }
}
...
class AnyRealmCollectionSectionedResultsPublisherTests: TestCase
{
  override class var defaultTestSuite: XCTestSuite
  {
    CombineSectionedResultsPublisherTests<AnyRealmCollection<ModernAllTypesObject>>.testSuite("AnyRealmCollection")
  }
}
...
class CombineProjectionPublisherTests: CombinePublisherTestCase
{
  ...
  func testSubscribeOn()
  {
    ...
    cancellable = valuePublisher(projection)
      .subscribe(on: subscribeOnQueue)
      .map
      { projection -> SimpleProjection in
        sema.signal()
  ...
  func testFrozenPublisherSubscribeOn()
  {
    ...
    cancellable = valuePublisher(projection)
      ...
      .freeze()
      .map
      { (v: SimpleProjection) -> SimpleProjection in
        gotValueEx.fulfill()
        return v
      }
      .collect()
  ...
  func testFrozenChangeSetSubscribeOn()
  {
    ...
    cancellable = changesetPublisher(projection)
      ...
      { arr in
        ...
        for change in arr
        {
          guard case let .change(p, properties) = change
          else
          {
            XCTFail("Expected .change but got \(change)")
            sema.signal()
