...
class SwiftUIServerTests: SwiftSyncTestCase
{
  ...
  func configuration(user _: User, partition _: String) -> Realm.Configuration
  {
    fatalError()
  }
  ...
  func asyncOpen(appId _: String?, partitionValue _: String, configuration _: Realm.Configuration,
                 timeout _: UInt? = nil, handler _: @escaping (AsyncOpenState) -> Void)
  {
    fatalError()
  }

  func asyncOpen(user _: User, appId _: String?, partitionValue _: String, timeout _: UInt? = nil,
                 handler _: @escaping (AsyncOpenState) -> Void)
  {
    fatalError()
  }
  ...
  {
    try asyncOpen(appId: appId, partitionValue: name, configuration: configuration(),
                  handler: handler)
  }
  ...
  func testAsyncOpenWaitingForUserWithoutUserLoggedIn() throws
  {
    ...
    asyncOpen(user: user, appId: appId, partitionValue: name)
    { asyncOpenState in
  ...
  func testAsyncOpenFailWithoutInternetConnection() throws
  {
    ...
    let appId = try RealmServer.shared.createApp(types: objectTypes)
    ...
    asyncOpen(user: user, appId: appId,
              partitionValue: name, timeout: 1000)
    { asyncOpenState in
  ...
  func testAsyncOpenWithACachedApp() throws
  {
    ...
    asyncOpen(user: createUser(), appId: nil, partitionValue: name)
    { asyncOpenState in
      if case let .open(realm) = asyncOpenState
      {
        self.checkCount(expected: SwiftSyncTestCase.bigObjectCount, realm, SwiftHugeSyncObject.self)
  ...
  func testAsyncOpenWithDifferentPartitionValues() throws
  {
    ...
    asyncOpen(user: createUser(), appId: nil, partitionValue: emptyPartition)
    { asyncOpenState in
      if case let .open(realm) = asyncOpenState
      {
  ...
  func testAsyncOpenWithMultiUserApp() throws
  {
    ...
    asyncOpen(user: syncUser2, appId: appId, partitionValue: name)
    { asyncOpenState in
      if case let .open(realm) = asyncOpenState
      {
        self.checkCount(expected: SwiftSyncTestCase.bigObjectCount, realm, SwiftHugeSyncObject.self)
    ...
    asyncOpen(user: syncUser1, appId: appId, partitionValue: name)
    { asyncOpenState in
      if case let .open(realm) = asyncOpenState
      {
        self.checkCount(expected: SwiftSyncTestCase.bigObjectCount, realm, SwiftHugeSyncObject.self)
  ...
  func testAsyncOpenWithUserAfterLogoutFromAnonymous() throws
  {
    ...
    asyncOpen(user: anonymousUser, appId: appId, partitionValue: name)
    { asyncOpenState in
      if case let .open(realm) = asyncOpenState
      {
        self.checkCount(expected: SwiftSyncTestCase.bigObjectCount, realm, SwiftHugeSyncObject.self)
    ...
    asyncOpen(user: createUser(), appId: appId, partitionValue: name)
    { asyncOpenState in
      if case let .open(realm) = asyncOpenState
      {
        self.checkCount(expected: SwiftSyncTestCase.bigObjectCount, realm, SwiftHugeSyncObject.self)
  ...
  func autoOpen(appId _: String?, partitionValue _: String, configuration _: Realm.Configuration,
                timeout _: UInt?, handler _: @escaping (AsyncOpenState) -> Void)
  {
    fatalError()
  }

  func autoOpen(user _: User, appId _: String?, partitionValue _: String, timeout _: UInt? = nil,
                handler _: @escaping (AsyncOpenState) -> Void)
  {
    fatalError()
  }
  ...
  {
    try autoOpen(appId: appId, partitionValue: name, configuration: configuration(),
  ...
  func testAutoOpenWaitingForUserWithoutUserLoggedIn() throws
  {
    ...
    autoOpen(user: user, appId: appId, partitionValue: name)
    { autoOpenState in
  ...
  func testAutoOpenOpenRealmWithoutInternetConnection() throws
  {
    ...
    autoOpen(user: user, appId: appId, partitionValue: name, timeout: 1000)
    { autoOpenState in
      if case let .open(realm) = autoOpenState
      {
  ...
  func testAutoOpenWithMultiUserApp() throws
  {
    ...
    autoOpen(user: syncUser2, appId: appId, partitionValue: partitionValueB)
    { autoOpenState in
      if case let .open(realm) = autoOpenState
      {
        self.checkCount(expected: 0, realm, SwiftHugeSyncObject.self)
    ...
    autoOpen(user: syncUser1, appId: appId, partitionValue: partitionValueA)
    { autoOpenState in
      if case let .open(realm) = autoOpenState
      {
        self.checkCount(expected: SwiftSyncTestCase.bigObjectCount, realm, SwiftHugeSyncObject.self)
  ...
  func testAutoOpenWithUserAfterLogoutFromAnonymous() throws
  {
    ...
    autoOpen(user: anonymousUser, appId: appId, partitionValue: partitionValueB)
    { autoOpenState in
      if case let .open(realm) = autoOpenState
      {
        self.checkCount(expected: 0, realm, SwiftHugeSyncObject.self)
    ...
    autoOpen(user: createUser(), appId: appId, partitionValue: partitionValueA)
    { autoOpenState in
      if case let .open(realm) = autoOpenState
      {
        self.checkCount(expected: SwiftSyncTestCase.bigObjectCount, realm, SwiftHugeSyncObject.self)
  ...
  func testAutoOpenWithDifferentPartitionValues() throws
  {
    ...
    autoOpen(user: user, appId: nil, partitionValue: partitionValueA)
    { autoOpenState in
      if case let .open(realm) = autoOpenState
      {
        self.checkCount(expected: SwiftSyncTestCase.bigObjectCount, realm, SwiftHugeSyncObject.self)
    ...
    autoOpen(user: user, appId: nil, partitionValue: partitionValueB)
    { autoOpenState in
      if case let .open(realm) = autoOpenState
      {
        self.checkCount(expected: 0, realm, SwiftHugeSyncObject.self)
  ...
  func testCombineAsyncOpenAutoOpenWithDifferentPartitionValues() throws
  {
    ...
    asyncOpen(user: user, appId: nil, partitionValue: partitionValueA)
    { asyncOpenState in
      if case let .open(realm) = asyncOpenState
      {
        self.checkCount(expected: SwiftSyncTestCase.bigObjectCount, realm, SwiftHugeSyncObject.self)
  ...
  func testCombineAsyncOpenAutoOpenWithMultiUserApp() throws
  {
    ...
    asyncOpen(user: syncUser1, appId: appId, partitionValue: partitionValueA)
    { asyncOpenState in
      if case let .open(realm) = asyncOpenState
      {
        self.checkCount(expected: SwiftSyncTestCase.bigObjectCount, realm, SwiftHugeSyncObject.self)
...
class PBSSwiftUIServerTests: SwiftUIServerTests
{
  override func configuration(user: User, partition: String) -> Realm.Configuration
  {
    ...
    userConfiguration.objectTypes = objectTypes
  ...
  override func asyncOpen(user: User, appId: String?, partitionValue: String, timeout: UInt? = nil,
                          handler: @escaping (AsyncOpenState) -> Void)
  {
    let configuration = configuration(user: user, partition: partitionValue)
...
class FLXSwiftUIServerTests: SwiftUIServerTests
{
  ...
  override func asyncOpen(appId: String?, partitionValue _: String, configuration: Realm.Configuration,
                          timeout: UInt? = nil, handler: @escaping (AsyncOpenState) -> Void)
  {
    let asyncOpen = AsyncOpen(appId: appId,
                              configuration: configuration,
  ...
  override func autoOpen(appId: String?, partitionValue _: String, configuration: Realm.Configuration,
                         timeout: UInt?, handler: @escaping (AsyncOpenState) -> Void)
  {
    let autoOpen = AutoOpen(appId: appId,
                            configuration: configuration,
