...
public extension XCTestCase
{
  ...
  func assertEqual<O: Object>(_ o1: O?, _ o2: O?, fileName: StaticString = #file, lineNumber: UInt = #line)
  {
    ...
    if let o1, let o2, o1.isSameObject(as: o2)
    {
      return
    }
  ...
  func assertFails(_ expectedError: Realm.Error.Code, _ message: String? = nil,
                   fileName: StaticString = #file, lineNumber: UInt = #line,
                   block: () throws -> some Any)
  {
    do
    {
  ...
  func assertFails(_ expectedError: Realm.Error.Code, _ file: URL, _ message: String,
                   fileName: StaticString = #file, lineNumber: UInt = #line,
                   block: () throws -> some Any)
  {
    do
  ...
  func assertFails(_ expectedError: Error, _: String? = nil,
                   fileName: StaticString = #file, lineNumber: UInt = #line,
                   block: () throws -> some Any)
  {
    do
  ...
  func assertNil(block: @autoclosure () -> (some Any)?, _ message: String? = nil,
                 fileName: StaticString = #file, lineNumber: UInt = #line)
  {
...
public func assertThrowsErrorAsync<E: Equatable & Error>(
...
public func assertPreconditionFailure(_ message: String, _ expression: () async throws -> some Any,
