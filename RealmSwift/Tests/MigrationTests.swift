...
class MigrationTests: TestCase
{
    ...
    func withTestFile(_ fn: () throws -> Void) throws
    {
      ...
      if let validation
      {
        try autoreleasepool
        {
          ...
          try validation(Realm(configuration: .init(fileURL: testRealmURL(), schemaVersion: schemaVersion)), schema)
        }
      }
  ...
  func testEnumerate() throws
  {
    ...
    try testMigration
    { migration, _ in
      migration.enumerateObjects(ofType: "SwiftStringObject")
      { _, _ in
    ...
    try testMigration(schemaVersion: 2)
    { migration, _ in
      var count = 0
      migration.enumerateObjects(ofType: "SwiftStringObject")
      { oldObj, newObj in
        guard let oldObj, let newObj
        else
        {
    ...
    try testMigration(schemaVersion: 3)
    { migration, _ in
      migration.enumerateObjects(ofType: "SwiftArrayPropertyObject")
      ...
      migration.enumerateObjects(ofType: "SwiftMutableSetPropertyObject")
      { oldObject, newObject in
        XCTAssertTrue(oldObject! as AnyObject is MigrationObject)
        XCTAssertTrue(newObject! as AnyObject is MigrationObject)
      ...
      migration.enumerateObjects(ofType: "SwiftMapPropertyObject")
      { oldObject, newObject in
        XCTAssertTrue(oldObject! as AnyObject is MigrationObject)
        XCTAssertTrue(newObject! as AnyObject is MigrationObject)
  ...
  func testBasicTypesInEnumerate() throws
  {
    ...
    try testMigration
    { migration, _ in
      migration.enumerateObjects(ofType: "SwiftObject")
      { oldObject, newObject in
  ...
  func testAnyInEnumerate() throws
  {
    ...
    func write(_ value: @autoclosure () -> AnyRealmValue, test: @escaping @Sendable (Any?, Any?) -> Void) throws
    {
      ...
      try testMigration(schemaVersion: version)
      { migration, _ in
        migration.enumerateObjects(ofType: "SwiftObject")
        { oldObject, newObject in
    ...
    try write(.object(SwiftIntObject()))
    { oldValue, newValue in
  ...
  func testOptionalsInEnumerate() throws
  {
    ...
    try testMigration
    { migration, _ in
      migration.enumerateObjects(ofType: "SwiftOptionalObject")
      { oldObject, newObject in
        XCTAssertTrue(oldObject! as AnyObject is MigrationObject)
        XCTAssertTrue(newObject! as AnyObject is MigrationObject)
  ...
  func testEnumerateObjectsAfterDeleteObjects() throws
  {
    ...
    try testMigration(schemaVersion: 1)
    { migration, _ in
      var count = 0
      migration.enumerateObjects(ofType: "SwiftStringObject")
      { oldObj, newObj in
      ...
      count = 0
      migration.enumerateObjects(ofType: "SwiftIntObject")
      { oldObj, newObj in
      ...
      count = 0
      migration.enumerateObjects(ofType: "SwiftInt8Object")
      { oldObj, newObj in
      ...
      count = 0
      migration.enumerateObjects(ofType: "SwiftInt16Object")
      { oldObj, newObj in
      ...
      count = 0
      migration.enumerateObjects(ofType: "SwiftInt32Object")
      { oldObj, newObj in
      ...
      count = 0
      migration.enumerateObjects(ofType: "SwiftInt64Object")
      { oldObj, newObj in
      ...
      migration.enumerateObjects(ofType: "SwiftBoolObject")
      { oldObj, newObj in
  ...
  func testCollectionAccess() throws
  {
    ...
    { migration, _ in
      var enumerated = false
      migration.enumerateObjects(ofType: "ModernAllTypesObject")
      { oldObj, _ in
        guard let oldObj
        else
        {
  ...
  func testObjectWithCustomColumnNames() throws
  {
    ...
    { migration, _ in
      var checkOnce = false
      migration.enumerateObjects(ofType: "ModernCustomObject")
      { oldObj, newObj in
