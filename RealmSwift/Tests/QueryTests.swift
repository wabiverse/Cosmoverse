...
class QueryTests: TestCase
{
  ...
  {
    getOrCreate(ModernCollectionObject.self)
  }
  ...
  {
    getOrCreate(ModernCircleObject.self)
  }
  ...
  func validateEqualsNil<Root: Object>(
    _ name: String, _ lhs: (Query<Root>) -> Query<some _RealmSchemaDiscoverable & ExpressibleByNilLiteral>
  )
  {
  ...
  func testSubquery()
  {
    ...
    {
      $0.intCol == 5 &&
        ($0.setCol.stringCol == "Bar").isEmpty
    }
    ...
    {
      !($0.arrayCol.arrayInt.count >= 0).isEmpty
    }
    ...
    {
      !($0.arrayCol.arrayInt.count >= 0 && !($0.arrayCol.intCol != 123).isEmpty).isEmpty
    }
    ...
    {
      !($0.arrayCol.intCol > 0 && $0.arrayCol.intCol <= 5).isEmpty
    }
    ...
    {
      ($0.arrayCol.stringCol == $0.stringCol).isEmpty
    }

    assertThrows(assertQuery("", count: 1)
    {
      ($0.stringCol == $0.stringCol).isEmpty
  ...
  private func validateCount<Root: Object>(_ name: String, _ lhs: (Query<Root>) -> Query<some RealmCollection>)
  {
  ...
  private func validateCount<Root: Object>(_ name: String, _ lhs: (Query<Root>) -> Query<some RealmKeyedCollection>)
  {
    assertQuery(Root.self, "(object.\(name).@count == %@)", 3, count: 1)
    {
      lhs($0).count == 3
...
extension BoolWrapper: QueryValue
{
  ...
  {
    Bool.queryValues().map(BoolWrapper.init)
  }
}
...
extension IntWrapper: QueryValue
{
  ...
  {
    Int.queryValues().map(IntWrapper.init)
  }
}
...
extension Int8Wrapper: QueryValue
{
  ...
  {
    Int8.queryValues().map(Int8Wrapper.init)
  }
}
...
extension Int16Wrapper: QueryValue
{
  ...
  {
    Int16.queryValues().map(Int16Wrapper.init)
  }
}
...
extension Int32Wrapper: QueryValue
{
  ...
  {
    Int32.queryValues().map(Int32Wrapper.init)
  }
}
...
extension Int64Wrapper: QueryValue
{
  ...
  {
    Int64.queryValues().map(Int64Wrapper.init)
  }
}
...
extension Float: QueryValue
{
  ...
  {
    [Float(5.55444333), Float(6.55444333), Float(7.55444333)]
  }
}
...
extension FloatWrapper: QueryValue
{
  ...
  {
    Float.queryValues().map(FloatWrapper.init)
  }
}
...
extension DoubleWrapper: QueryValue
{
  ...
  {
    Double.queryValues().map(DoubleWrapper.init)
  }
}
...
extension StringWrapper: QueryValue
{
  ...
  {
    String.queryValues().map(StringWrapper.init)
  }
}
...
extension DataWrapper: QueryValue
{
  ...
  {
    Data.queryValues().map(DataWrapper.init)
  }
}
...
extension Date: QueryValue
{
  ...
  {
    [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000), Date(timeIntervalSince1970: 3_000_000)]
  }
}
...
extension DateWrapper: QueryValue
{
  ...
  {
    Date.queryValues().map(DateWrapper.init)
  }
}
...
extension Decimal128: QueryValue
{
  ...
  {
    [Decimal128(123.456), Decimal128(234.567), Decimal128(345.678)]
  }
}
...
extension Decimal128Wrapper: QueryValue
{
  ...
  {
    Decimal128.queryValues().map(Decimal128Wrapper.init)
  }
}
...
extension ObjectIdWrapper: QueryValue
{
  ...
  {
    ObjectId.queryValues().map(ObjectIdWrapper.init)
  }
}
...
extension UUID: QueryValue
{
  ...
  {
    [UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09e")!, UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09f")!, UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d08e")!]
  }
}
...
extension UUIDWrapper: QueryValue
{
  ...
  {
    UUID.queryValues().map(UUIDWrapper.init)
  }
}
...
extension ModernIntEnum: QueryValue
{
  ...
  {
    value1.rawValue + value2.rawValue + value3.rawValue
  }
...
extension AnyRealmValue: QueryValue
{
  ...
  {
    [AnyRealmValue.objectId(ObjectId("61184062c1d8f096a3695046")), AnyRealmValue.string("Hello"), AnyRealmValue.int(123)]
  }
}
...
extension Optional: QueryValue where Wrapped: QueryValue
{
  static func queryValues() -> [Self]
  {
    Wrapped.queryValues().map(Self.init)
  }
}
...
extension IntWrapper: AddableQueryValue
{
  ...
  fileprivate static func sum() -> SumType
  {
    IntWrapper(persistedValue: Int.sum())
  }

  fileprivate static func average() -> SumType
  {
    IntWrapper(persistedValue: Int.average())
  }
}
...
extension Int8Wrapper: AddableQueryValue
{
  ...
  fileprivate static func sum() -> SumType
  {
    Int8Wrapper(persistedValue: Int8.sum())
  }

  fileprivate static func average() -> SumType
  {
    Int8Wrapper(persistedValue: Int8.average())
  }
}
...
extension Int16Wrapper: AddableQueryValue
{
  ...
  fileprivate static func sum() -> SumType
  {
    Int16Wrapper(persistedValue: Int16.sum())
  }

  fileprivate static func average() -> SumType
  {
    Int16Wrapper(persistedValue: Int16.average())
  }
}
...
extension Int32Wrapper: AddableQueryValue
{
  ...
  fileprivate static func sum() -> SumType
  {
    Int32Wrapper(persistedValue: Int32.sum())
  }

  fileprivate static func average() -> SumType
  {
    Int32Wrapper(persistedValue: Int32.average())
  }
}
...
extension Int64Wrapper: AddableQueryValue
{
  ...
  fileprivate static func sum() -> SumType
  {
    Int64Wrapper(persistedValue: Int64.sum())
  }

  fileprivate static func average() -> SumType
  {
    Int64Wrapper(persistedValue: Int64.average())
  }
}
...
extension FloatWrapper: AddableQueryValue
{
  ...
  fileprivate static func sum() -> SumType
  {
    FloatWrapper(persistedValue: Float.sum())
  }

  fileprivate static func average() -> SumType
  {
    FloatWrapper(persistedValue: Float.average())
  }
}
...
extension DoubleWrapper: AddableQueryValue
{
  ...
  fileprivate static func sum() -> SumType
  {
    DoubleWrapper(persistedValue: Double.sum())
  }

  fileprivate static func average() -> SumType
  {
    DoubleWrapper(persistedValue: Double.average())
  }
}
...
extension Decimal128Wrapper: AddableQueryValue
{
  ...
  fileprivate static func sum() -> SumType
  {
    Decimal128Wrapper(persistedValue: Decimal128.sum())
  }

  fileprivate static func average() -> SumType
  {
    Decimal128Wrapper(persistedValue: Decimal128.average())
  }
}
