...
public final class List<Element: RealmCollectionValue>: RLMSwiftCollectionBase, RealmCollectionImpl
{
  ...
  var rlmArray: RLMArray<AnyObject>
  {
  ...
  {
    rlmArray.value(forKeyPath: key)! as! [AnyObject]
  }
  ...
  {
    rlmArray.value(forKeyPath: keyPath) as! [AnyObject]
  }
  ...
  {
    RLMDescriptionWithMaxDepth("List", _rlmCollection, depth)
  }
}
