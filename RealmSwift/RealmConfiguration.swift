...
public extension Realm
{
  ...
  @frozen struct Configuration: Sendable
  {
    ...
    public static var defaultConfiguration: Configuration
    {
      get
      {
        fromRLMRealmConfiguration(RLMRealmConfiguration.default())
      }
      set
      {
    ...
    public var objectTypes: [ObjectBase.Type]?
    {
      get
      {
        customSchema.map { $0.objectSchema.compactMap { $0.objectClass as? ObjectBase.Type } }
      }
      set
      {
    ...
    var rlmConfiguration: RLMRealmConfiguration
    {
      ...
      else if let inMemoryIdentifier
      {
...
extension Realm.Configuration: CustomStringConvertible
{
  ...
  {
    gsub(pattern: "\\ARLMRealmConfiguration",
